    ...
    switch (serializableHiveEvent.getEventType()) {
      case ON_ADD_PARTITION:
        {
          ...
          hiveEvent =
              new AddPartitionEvent(
                  addPartition.getTable(),
                  addPartition.getPartitions(),
                  addPartition.getStatus(),
      ...
      case ON_ALTER_PARTITION:
        {
          ...
          hiveEvent =
              new AlterPartitionEvent(
                  ...
                  alterPartition.getNewPartition(),
                  alterPartition.getTable(),
                  alterPartition.getStatus(),
                  false,
                  null,
                  hmsHandlerFactory.newInstance());
          break;
      ...
      case ON_DROP_PARTITION:
        {
          ...
          hiveEvent =
              new DropPartitionEvent(
                  dropPartition.getTable(),
                  dropPartition.getPartitions().get(0),
                  dropPartition.getStatus(),
                  dropPartition.getDeleteData(),
                  hmsHandlerFactory.newInstance());
          break;
        }
      ...
      default:
        throw new DroneFlyException(
            "Unsupported event type: " + serializableHiveEvent.getEventType().toString());
    }
