...
public class LoggingMetastoreListener extends MetaStoreEventListener {
  ...
  public void onAddPartition(AddPartitionEvent addPartitionEvent) throws MetaException {
    log.info(
        "Event Type: {}, DB Name: {}, Table Name: {}, Status: {}",
        EventType.ADD_PARTITION.toString(),
        addPartitionEvent.getTable().getDbName(),
        addPartitionEvent.getTable().getTableName(),
  ...
  public void onCreateDatabase(CreateDatabaseEvent createDatabaseEvent) throws MetaException {
    log.info(
        "Event Type: {}, DB Name: {}, DB Location: {}, Status: {}",
        EventType.CREATE_DATABASE.toString(),
        createDatabaseEvent.getDatabase().getName(),
        createDatabaseEvent.getDatabase().getLocationUri(),
  ...
  public void onCreateTable(CreateTableEvent createTableEvent) throws MetaException {
    log.info(
        ...
        createTableEvent.getTable().getDbName(),
  ...
  public void onDropDatabase(DropDatabaseEvent dropDatabaseEvent) throws MetaException {
    log.info(
        ...
        dropDatabaseEvent.getDatabase().getName(),
        dropDatabaseEvent.getDatabase().getLocationUri(),
  ...
  public void onDropPartition(DropPartitionEvent dropPartitionEvent) throws MetaException {
    log.info(
        ...
        dropPartitionEvent.getTable().getDbName(),
        dropPartitionEvent.getTable().getTableName(),
  ...
  public void onDropTable(DropTableEvent dropTableEvent) throws MetaException {
    log.info(
        ...
        dropTableEvent.getTable().getDbName(),
  ...
  public void onAlterTable(AlterTableEvent alterTableEvent) throws MetaException {
    log.info(
        ...
        alterTableEvent.getOldTable().getDbName(),
        alterTableEvent.getOldTable().getTableName(),
        alterTableEvent.getOldTable().getSd().getLocation(),
        alterTableEvent.getNewTable().getDbName(),
        alterTableEvent.getNewTable().getTableName(),
        alterTableEvent.getNewTable().getSd().getLocation(),
  ...
  public void onAlterPartition(AlterPartitionEvent alterPartitionEvent) throws MetaException {
    log.info(
        ...
        alterPartitionEvent.getOldPartition().getDbName(),
        alterPartitionEvent.getOldPartition().getTableName(),
        alterPartitionEvent.getOldPartition().getSd().getLocation(),
        alterPartitionEvent.getNewPartition().getSd().getLocation(),
        alterPartitionEvent.getStatus());
  }

  @Override
  public void onCreateFunction(CreateFunctionEvent createFunctionEvent) throws MetaException {
    log.info(
        "Event Type: {}, Function Name: {}, Function Class Name: {}, Status: {}",
        EventType.CREATE_FUNCTION.toString(),
        createFunctionEvent.getFunction().getFunctionName(),
        createFunctionEvent.getFunction().getClassName(),
        createFunctionEvent.getStatus());
  }
  ...
  public void onDropFunction(DropFunctionEvent dropFunctionEvent) throws MetaException {
    log.info(
        "Event Type: {}, Function Name: {}, Function Class Name: {}, Status: {}",
        EventType.DROP_FUNCTION.toString(),
        dropFunctionEvent.getFunction().getClassName(),
        dropFunctionEvent.getFunction().getClassName(),
        dropFunctionEvent.getStatus());
  }
}
