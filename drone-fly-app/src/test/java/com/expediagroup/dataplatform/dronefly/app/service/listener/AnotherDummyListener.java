...
public class AnotherDummyListener extends MetaStoreEventListener {

  public final List<ListenerEvent> notifyList = new ArrayList<>();

  /**
   * @return The last event received, or null if no event was received.
   */
  public ListenerEvent getLastEvent() {
  ...
  public AnotherDummyListener(Configuration config) {
    super(config);
  }
